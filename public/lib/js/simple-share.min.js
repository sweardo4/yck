var SimpleShare = function (a) {
	function b(a) {
		return a = a.replace("{url}", c), a = a.replace("{title}", d), a = a.replace("{content}", e), a = a.replace("{pic}",
			f)
	}
	a = a || {};
	var c = a.url || window.location.href,
		...
		e = a.content || "",
		f = a.pic || "";
	c = encodeURIComponent(c), d = encodeURIComponent(d), e = encodeURIComponent(e), f = encodeURIComponent(f);
	var g =
